...
mod tests {
    ...
    mod mutate {
        ...
        fn actual_mutation_child(chance: f32, coeff: f32) -> Vec<f32> {
        ...
        mod given_zero_chance {
            fn actual(coeff: f32) -> Vec<f32> {
                super::actual_mutation_child(0.0, coeff)
            }
        ...
        mod given_fifty_fifty_chance {
            fn actual(coeff: f32) -> Vec<f32> {
                super::actual_mutation_child(0.5, coeff)
            }
        ...
        mod given_max_chance {
            fn actual(coeff: f32) -> Vec<f32> {
                super::actual_mutation_child(1.0, coeff)
            }
